...
@Service
@Command(scope = "cave", name = "repository-location", description = "Get or set the repository location")
public class RepositoryLocationCommand implements Action {
    ...
    @Argument(index = 1, name = "location", description = "The new repository location", required = false, multiValued = false)
    String location;
    ...
    public Object execute() throws Exception {
        ...
        System.out.println(repositoryService.repository(name).getLocation());
        return null;
    }
