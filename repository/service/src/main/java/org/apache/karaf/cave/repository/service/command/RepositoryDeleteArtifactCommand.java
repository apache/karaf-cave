...
@Service
@Command(scope = "cave", name = "repository-artifact-delete", description = "Delete an artifact from a given repository")
public class RepositoryDeleteArtifactCommand implements Action {
    ...
    @Argument(index = 1, name = "artifactUrl", description = "The artifact URL", required = true, multiValued = false)
    String url;
    ...
    public Object execute() throws Exception {
        ...
        repositoryService.deleteArtifact(url, name);
        return null;
    }
