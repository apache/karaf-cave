...
@Service
@Command(scope = "cave", name = "repository-update-bundle-descriptor", description = "Update (eventually create) the bundle repository XML descriptor")
public class RepositoryUpdateBundleDescriptorCommand implements Action {

    @Reference
    private RepositoryService repositoryService;

    @Argument(index = 0, name = "name", description = "The repository", required = true, multiValued = false)
