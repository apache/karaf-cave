...
@Service
@Command(scope = "cave", name = "repository-list", description = "List repositories")
public class RepositoryListCommand implements Action {
    ...
    public Object execute() throws Exception {
        ...
        for (Repository repository : repositoryService.repositories()) {
            table.addRow().addContent(repository.getName(), repository.getLocation(), repository.getUrl());
        }
